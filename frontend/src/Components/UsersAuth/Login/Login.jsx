...
import { loginUserAction } from "../../../redux/Features/slices/userSlice";
...
const Login = () => {
  ...
  return (
    <section className="min-h-screen relative py-20 2xl:py-20 bg-zinc-50 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-wrap items-center -mx-4">
            ...
            <div className="w-full lg:w-3/5 px-4 mb-16 lg:mb-0 order-first lg:order-last">
              <span className="flex mb-10 mx-auto items-center justify-center h-120 w-300  rounded-lg animate-bounce">
                <img
                  src="/images/logo.png"
                  alt="Logo_1"
                ></img>
              </span>
              <h2 className="mb-10 text-center text-6xl lg:text-7xl text-black-500 font-bold font-heading animate-pulse">
                Lets Commute? Login Now.
              </h2>
            </div>
          </div>
        </div>
