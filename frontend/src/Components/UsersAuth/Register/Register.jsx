...
import { registerUserAction } from '../../../redux/Features/slices/userSlice';
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap items-center -mx-4">
              <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                ...
                <span className="flex mx-auto items-center justify-center h-120 w-300  rounded-lg animate-bounce">
                <img
                  src="/images/logo.png"
                  alt="Logo_1"
                ></img>
              ...
              <div className="w-full lg:w-1/2 px-4">
                <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-100 shadow-lg rounded-lg">
